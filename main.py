'''Contact Book project in python using Tkinter and MySQL Database'''
...
class Management:
    def __init__(self, root):
        ...
        self.display_bt = Button(self.frame_2, text='View', font=(cs.font_1, 12), bd=2, command=self.DisplayRecords, cursor="hand2", bg=self.color_2,fg=self.color_3).place(x=50,y=100,width=100)
